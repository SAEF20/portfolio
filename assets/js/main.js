...
/*==================== SWIPER PROJECTS MAIN PAGE (تهيئة منزلق المشاريع للرئيسية) ====================*/
let swiperProjectsMain = new Swiper('.projects__container', {
    // cssMode: true, // قمنا بإيقافه مؤقتاً لأنه قد يسبب مشاكل في التجاوب مع الأسهم في بعض الحالات
    loop: true,    
    grabCursor: true, // إضافة مؤشر اليد عند السحب لتحسين تجربة المستخدم
    
    // ربط الأسهم الفريدة الجديدة 👉
    navigation: {
      nextEl: '.projects__swiper-next',
      prevEl: '.projects__swiper-prev',
    },
    // ربط نقاط التنقل الفريدة الجديدة 👉
    pagination: {
...
// let projectsSwiper = new Swiper('.project__slider', {
//     effect: 'coverflow',
//     grabCursor: true,
//     centeredSlides: true,
//     slidesPerView: 'auto',
